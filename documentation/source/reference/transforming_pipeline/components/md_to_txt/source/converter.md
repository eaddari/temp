# microservices.transforming_pipeline.components.md_to_txt.source.converter

Source file: `microservices\transforming_pipeline\components\md_to_txt\source\converter.py`
